...
public class UDPCSListener implements Runnable {
	...
	public void run() {
		...
		try (MulticastSocket socket = new MulticastSocket(port)) {
			socket.joinGroup(InetAddress.getByName(Repository.MONCS_GROUP));
	...
	public static void setSequencer(int i) {
		expectedSequence = i;
		System.out.println("Resetting sequence number "+ expectedSequence);
